...
export class PhotoEditorComponent implements OnInit {
  //to receive our member from the parent controller
  @Input() member: Member;
...
setMainPhoto(photo: Photo){
  ...
  initializeUploader() {
    this.uploader = new FileUploader({
      ...
      autoUpload: false,
      maxFileSize: 10 * 1024 * 1024 //10MB is the max file size allowed on coudinary service
    });
